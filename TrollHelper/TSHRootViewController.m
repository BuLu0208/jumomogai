...
- (NSMutableArray*)specifiers
{
	if(!_specifiers)
	{
		...
		// ========== 广告区域 ==========
		PSSpecifier* adGroupSpecifier = [PSSpecifier emptyGroupSpecifier];
		[adGroupSpecifier setProperty:@"🚀 需要科学上网？添加老司机V：jiesuo66688\n稳定高速，试用免费，欢迎体验！" forKey:@"footerText"];
		[_specifiers addObject:adGroupSpecifier];
